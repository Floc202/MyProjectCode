document.addEventListener("DOMContentLoaded", function () {
  ...
  let select = (s) => document.querySelector(s),
    ...
    style = getComputedStyle(document.body), // Đảm bảo document.body tồn tại khi DOM đã sẵn sàng
    uiGrey = style.getPropertyValue("--ui-grey"),
    uiBlue = style.getPropertyValue("--ui-blue");
	console.log("uiGrey:", uiGrey);
    console.log("uiBlue:", uiBlue);
...
tl.add("offSelected")
  ...
  .to(
    ["#allRobotHands", "#robotThumb, #offDot"],
    {
      y: "-=50",
      duration: 0.15,
      ease: "sine.in",
  ...
  .to(
    ["#robotHand", "#robotHandHorns", "#robotThumb"],
    {
